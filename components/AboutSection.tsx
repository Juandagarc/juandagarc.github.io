                    ...
                    <div style={{ position: "relative", flexShrink: 0, width: px(1013) }}>
                        ...
                        <div style={{ position: "absolute", left: px(18), top: px(225), display: "flex", flexDirection: "column", gap: px(40), zIndex: 10 }}>
                            ...
                            <div style={{ display: "flex", gap: px(26) }}>
                                {/* GitHub */}
                                <a href="https://github.com/Juandagarc" target="_blank" rel="noopener noreferrer" style={{ color: "white", transition: "color 0.2s", display: "flex", alignItems: "center", justifyContent: "center", width: px(48), height: px(48) }} onMouseOver={(e) => e.currentTarget.style.color = "#07cf07"} onMouseOut={(e) => e.currentTarget.style.color = "white"}>
                                ...
                                {/* LinkedIn */}
                                <a href="https://linkedin.com/in/juandagarc" target="_blank" rel="noopener noreferrer" style={{ color: "white", transition: "color 0.2s", display: "flex", alignItems: "center", justifyContent: "center", width: px(48), height: px(48) }} onMouseOver={(e) => e.currentTarget.style.color = "#07cf07"} onMouseOut={(e) => e.currentTarget.style.color = "white"}>
                                ...
                                {/* Instagram */}
                                <a href="https://instagram.com/juandagarc" target="_blank" rel="noopener noreferrer" style={{ color: "white", transition: "color 0.2s", display: "flex", alignItems: "center", justifyContent: "center", width: px(48), height: px(48) }} onMouseOver={(e) => e.currentTarget.style.color = "#07cf07"} onMouseOut={(e) => e.currentTarget.style.color = "white"}>
