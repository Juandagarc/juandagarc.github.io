...
// Social icon refs (inline SVGs – no external icon lib needed)
const GitHubIcon = () => (
                            ...
                            <div style={{ display: "flex", gap: px(26) }}>
                                {socialLinks.map(({ href, label, Icon }) => (
                                    <a key={label} href={href} target="_blank" rel="noopener noreferrer" aria-label={label}
                                        style={{ color: "white", transition: "color 0.2s", display: "flex", alignItems: "center", justifyContent: "center", width: px(48), height: px(48) }}
                                        onMouseOver={e => (e.currentTarget.style.color = "#07cf07")}
                                        onMouseOut={e => (e.currentTarget.style.color = "white")}
                                    >
                                        <Icon />
